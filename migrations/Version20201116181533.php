 ...
 */
final class Version20201116181533 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE job_product (id INT AUTO_INCREMENT NOT NULL, job_id INT NOT NULL, product INT NOT NULL, INDEX IDX_49A5B336BE04EA9 (job_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
